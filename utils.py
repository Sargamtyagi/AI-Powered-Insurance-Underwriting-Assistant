...
<a target='_blank'
  href='https://console.cloud.google.com/vertex-ai/studio/saved-prompts/locations/us-central1/7865288809330507776?project=qwiklabs-gcp-02-bc60a180f868&deploy=true'>
  Vertex AI Studio
...
<ul style="list-style-position: outside; margin-left: 1em;">
  <li>Go to Cloud Run
    <a target='_blank'
       href='https://console.cloud.google.com/run/detail/us-central1/genai-app-insuranceunderwritingsumm-1-17508710985/source?project=qwiklabs-gcp-02-bc60a180f868'
    >
      source code editor
  ...
  <li>Go to your
    <a target='_blank'
       href='https://console.cloud.google.com/vertex-ai/studio/saved-prompts/locations/us-central1/7865288809330507776?project=qwiklabs-gcp-02-bc60a180f868'
    >
  ...
  <li>Go to Cloud Run
    <a target='_blank'
       href='https://console.cloud.google.com/run/detail/us-central1/genai-app-insuranceunderwritingsumm-1-17508710985/security?project=qwiklabs-gcp-02-bc60a180f868'
    >
      Security settings
